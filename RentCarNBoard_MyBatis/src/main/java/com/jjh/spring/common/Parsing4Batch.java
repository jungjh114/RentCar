...
public class Parsing4Batch {
	...
	public static void main(String[] args) throws Exception {
		...
		String[] setters1 = new String[] { 
				...
				"setInfo" };
		RentCar x = (RentCar) parser.parsing("SONATA/3/50000/4/현대/sonata.jpg/참좋은차다", setters1);
		System.out.println(x);
		// ---------------------------------------------------------
		Parsing4Batch parser2 = new Parsing4Batch(JSPMember.class, "/");
		String[] setters2 = new String[] { "setId", "setPass", "setEmail", "setTel", "setAge", "setJob", "setHobby" };
		JSPMember mem = (JSPMember) parser2.parsing("sjw/1234/jaain@naver.com/010-2307-3558/60대/교수/등산", setters2);
